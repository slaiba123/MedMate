  ...
  useEffect(() => {
    const fetchDoctors = async () => {
      try {
        ...
        const fetchedDoctors: Doctor[] = (res.data.doctors || res.data).map((doc: any) => ({
          _id: doc._id,
          name: doc.name || "Unknown Doctor",
          specialization: doc.specialization || "General",
          details: {
            image: doc.details?.image || doc.image || "/default-doctor.jpg",
            education: doc.details?.education || doc.education || "Not Available",
          },
        }));
